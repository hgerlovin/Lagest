...
#'    \item{ID}{Subject identifier. Increments from 1 to input value "repper". Dataframe sorted by ID and then time.}
#'    \item{scen.num}{Scenario number. Takes value 1 -- Redundant and not used.}
#' }
