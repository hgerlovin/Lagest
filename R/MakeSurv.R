...
#' 
#' @param datin A dataframe that must have "time", "tstop" and "event" columns with data points for all subjects at all event times.
#' @return Outputs full dataset at event times
#' @seealso makeDat.cph
#' @export
